...
const About = () => {
  ...
  const features = [
    {
      icon: Building,
      title: language === 'ar' ? 'مشاريع عقارية متنوعة' : 'Diverse Real Estate Projects',
  ...
  const contactInfo = [
    ...
    {
      icon: Phone,
      title: language === 'ar' ? 'قسم المنفذ والوصي' : 'Executor and Trustee Department',
      value: '+20 2 1234 5678',
      description: language === 'ar' ? 'خلال ساعات العمل' : 'During business hours'
    },
    {
      icon: Mail,
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 animate-fade-in">
            {language === 'ar' ? 'عن بنك القاهرة للتنمية والائتمان العقاري' : 'About BDC'}
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed animate-fade-in">
            {language === 'ar' 
              ? 'بنك القاهرة للتنمية والائتمان العقاري هو مؤسسة رائدة في مجال العقارات والتمويل العقاري في مصر. نسعى لتوفير أفضل الحلول العقارية وأكثرها ابتكاراً لعملائنا، مع التزامنا بأعلى معايير الجودة والخدمة.'
              : 'BDC is a leading institution in real estate and real estate financing in Egypt. We strive to provide our clients with the best and most innovative real estate solutions, while maintaining our commitment to the highest standards of quality and service.'
            }
          </p>
        </div>
      </section>
                ...
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      ...
                      {language === 'ar' ? 'الشفافية والصدق' : 'Transparency and Honesty'}
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                      {language === 'ar' ? 'الجودة والتميز' : 'Quality and Excellence'}
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                      {language === 'ar' ? 'الابتكار والتطوير' : 'Innovation and Development'}
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-white rounded-full mr-3"></div>
                      {language === 'ar' ? 'خدمة العملاء المتميزة' : 'Exceptional Customer Service'}
                    </li>
                  </ul>
                </CardContent>
              </Card>
